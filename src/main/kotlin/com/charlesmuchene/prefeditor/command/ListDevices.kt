...
import com.charlesmuchene.prefeditor.parser.DeviceListParser
import com.charlesmuchene.prefeditor.parser.Parser

data class ListDevices(override val parser: Parser<Devices> = DeviceListParser()) : ReadCommand<Devices> {
